...
public class VideoViewOptions extends TextureView implements MediaController.MediaPlayerControl {
    ...
    public VideoViewOptions(final Context context) {
        super(context);
        mContext = context;
        initVideoView();
    }

    public VideoViewOptions(final Context context, final AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        initVideoView();
    }

    public VideoViewOptions(Context context, AttributeSet attrs, int defStyle) {
